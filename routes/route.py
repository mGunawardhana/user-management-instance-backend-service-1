...
def handle_exception(e, message):
    raise HTTPException(status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail=f"{message}: {str(e)}")
...
async def create_user(user: User):
    ...
    try:
        ...
        return inserted_id and {"data": {"id": str(inserted_id)}, "message": "Todo created successfully",
                                "status_code": 201}
    except Exception as e:
...
async def update_user(user_id: str, user: User):
    try:
        ...
        return result and {"data": {"id": user_id}, "message": "User updated successfully", "status_code": 200}
    except Exception as e:
...
async def delete_user(user_id: str):
    try:
        ...
        return result.deleted_count == 1 and {"data": {"id": user_id}, "message": "User deleted successfully",
                                              "status_code": 200}
    except Exception as e:
...
async def get_user_by_id(user_id: str):
    try:
        ...
        return user_data and {"data": user_data, "message": "User retrieved successfully", "status_code": 200}
    except Exception as e:
